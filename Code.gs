//CONSTANTS
const SPREADSHEETID = "1IeRV1zJ1gsdGi2n7rFZ7b6w534lLPy86ZusqsMuiObU";
const DATARANGE = "chat_id_telegram!A2:E";
const DATASHEET = "chat_id_telegram";
const DATASHEETID = "0";
const LASTCOL = "E";
const IDRANGE = "chat_id_telegram!A2:A";
...
function processForm(formObject) {
  if (formObject.recId && checkId(formObject.recId)) {
    const values = [[
      formObject.recId,
      formObject.mamoigioi,
      formObject.tenmoigioi,
      formObject.chatidtelegram,      
...
function getRangeById(id) {
  ...
  const range = `chat_id_telegram!A${rowIndex + 2}:${LASTCOL}${rowIndex + 2}`;
  return range;
}
